...
class SystemConfig:
    ...
    # 데이터 수집 주기
    PRICE_COLLECTION_INTERVAL: int = 60  # 초
    METADATA_UPDATE_INTERVAL: int = 3600 * 24  # 일 1회
    KIMCHI_CALCULATION_INTERVAL: int = 60  # 초
    
    # 데이터 보관 기간
    PRICE_DATA_RETENTION_DAYS: int = 90
    ...
    FX_RATE_UPDATE_INTERVAL: int = 3600  # 1시간마다
